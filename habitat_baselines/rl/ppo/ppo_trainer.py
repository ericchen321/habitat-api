...
class PPOTrainer(BaseRLTrainer):
    ...
    def _eval_checkpoint_bruce(
        ...
        return (self.actor_critic, batch, not_done_masks, test_recurrent_hidden_states)
    ...
    def eval_bruce(self):
        ...
        if os.path.isfile(self.config.EVAL_CKPT_PATH_DIR):
                ...
                actor_critic, batch, not_done_masks, test_recurrent_hidden_states = self._eval_checkpoint_bruce(self.config.EVAL_CKPT_PATH_DIR)
        else:
